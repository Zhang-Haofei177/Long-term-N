...
wd="~/iCamp/AMF/Input/"
com.file="~/iCamp/AMF/Input/AMF_ASV(zhengshu).txt"
tree.file="~/iCamp/AMF/Input/AMF_tree.unrooted.nwk"
clas.file <- "~/iCamp/AMF/Input/AMF_tax.txt"
treat.file="~/iCamp/AMF/Input/group.txt"
env.file="~/iCamp/AMF/Input/env.txt"
save.wd="~/iCamp/AMF/OutPut/"
...
#############################利用FOR循环计算不同size值的RAsig##########################
# 设置bin.size.limit的不同值，结果定为24
bin.size.limits = c(12,24, 36, 48)

# 循环遍历不同的bin.size.limit
